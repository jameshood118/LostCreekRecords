...
<a href="musicplayer3.php?album_select=One Face at a Time" class="menuLink">One Face at a Time</a>
...
print ('<a href="music sources/'.$album_name.'/'.$track_name.'.mp3" title="Play '.$track_name.'" class="sm2_button" id='.$idnum.'>'.$track_name.'</a><img src="images/titles/'.$album_name.'/'.$track_name.'.png" width="250px" />');
?>
...
$new_album = str_replace(" ", "%20", $album_name);
$new_track = str_replace(" ", "%20", $track_name);
$new_track2 = str_replace("&#039;", "", $new_track);

?>
<script type="text/javascript">
$(document).ready(function(){
  $("#<?php echo $idnum?>").click(function(){
    $("#lyrics").load('music%20sources/<?php echo $new_album?>/lyrics2/<?php echo $new_track2?>.txt');
  });
});
</script>
<?php
